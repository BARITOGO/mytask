...
public class logingradient extends JPanel{
    ...
    protected void paintChildren(Graphics g) {
        ...
        GradientPaint gradient = new GradientPaint(0, 0, Color.decode("#F8FFD2"), 0, getHeight(), Color.decode("#69CBD2"));
