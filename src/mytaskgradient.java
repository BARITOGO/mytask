...
public class mytaskgradient extends JPanel{
    ...
    protected void paintChildren(Graphics g) {
        ...
        GradientPaint gradient = new GradientPaint(0, 0, Color.decode("##F5A694"), 0, getHeight(), Color.decode("##F5A694"));
